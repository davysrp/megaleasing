<!--Action Button-->
@if( Active::checkUriPattern( 'admin/subscribers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.subscribers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.subscribers.all' ) }}
            </a>
        </li>
        @permission( 'create-subscriber' )
            <li>
                <a href="{{ route( 'admin.subscribers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.subscribers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
