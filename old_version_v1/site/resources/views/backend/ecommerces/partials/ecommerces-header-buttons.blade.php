<!--Action Button-->
@if( Active::checkUriPattern( 'admin/ecommerces' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.ecommerces.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.ecommerces.all' ) }}
            </a>
        </li>
        @permission( 'create-ecommerce' )
            <li>
                <a href="{{ route( 'admin.ecommerces.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.ecommerces.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
