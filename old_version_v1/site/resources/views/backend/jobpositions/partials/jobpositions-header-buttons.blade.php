<!--Action Button-->
@if( Active::checkUriPattern( 'admin/jobpositions' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.jobpositions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.jobpositions.all' ) }}
            </a>
        </li>
        @permission( 'create-jobposition' )
            <li>
                <a href="{{ route( 'admin.jobpositions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.jobpositions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
