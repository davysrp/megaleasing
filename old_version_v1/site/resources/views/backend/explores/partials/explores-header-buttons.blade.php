<!--Action Button-->
@if( Active::checkUriPattern( 'admin/explores' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.explores.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.explores.all' ) }}
            </a>
        </li>
        @permission( 'create-explore' )
            <li>
                <a href="{{ route( 'admin.explores.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.explores.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
