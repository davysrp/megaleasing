<!--Action Button-->
@if( Active::checkUriPattern( 'admin/phoductphotos' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.phoductphotos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.phoductphotos.all' ) }}
            </a>
        </li>
        @permission( 'create-phoductphoto' )
            <li>
                <a href="{{ route( 'admin.phoductphotos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.phoductphotos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
