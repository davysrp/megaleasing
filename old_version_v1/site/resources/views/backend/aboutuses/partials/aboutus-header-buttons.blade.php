<!--Action Button-->
@if( Active::checkUriPattern( 'admin/aboutus' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.aboutus.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.aboutus.all' ) }}
            </a>
        </li>
        @permission( 'create-aboutu' )
            <li>
                <a href="{{ route( 'admin.aboutus.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.aboutus.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
