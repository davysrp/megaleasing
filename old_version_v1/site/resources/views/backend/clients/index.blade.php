        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="clients-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>{{ trans('labels.backend.clients.table.id') }}</th>
                            <th>{{ trans('labels.backend.clients.table.name') }}</th>
    ...
    <script>
        ...
        $(function() {
            ...
            var dataTable = $('#clients-table').dataTable({
                ...
                columns: [
                    {data: 'id', name: '{{config('module.clients.table')}}.id'},
                    {data: 'name', name: '{{config('module.clients.table')}}.name'},
                    {data: 'created_at', name: '{{config('module.clients.table')}}.created_at'},
