...
<!--                                            @endif-->
                                    ...
                                    <div class="content-form">
                                        ...
                                        @endif
                                         ...
                                         {{ Form::open(['route' => 'frontend.jobapplication', 'class' => 'needs-validation', 'role' => 'form', 'novalidate','method' => 'post', 'id' => 'create-explore', 'enctype'=>'multipart/form-data']) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" required id="t-email" value="" name="temail">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">@lang('mega.cvLink') </label>
                                                        <br>
                                                        <input type="file"  id="file" required value="" name="file">
                                                        <div class="invalid-feedback">
