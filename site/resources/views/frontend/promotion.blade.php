...
@section('content')
    ...
    <div class="ad-page-section section-bg">
        ...
        <?php /*senction branch*/
        $promotions = \App\Models\Promotion\Promotion::orderBy('created_at', 'DESC')->paginate(10);
        $i=1;
        ?>
                            ...
                            <article class="col-md-4">
                                <div class="ad-s-news_item">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{!! route('frontend.promotion',['id'=>$item->id,'slug'=>\Illuminate\Support\Str::slug($item->title_eng)]) !!}" class="btn-secondary">@lang('mega.readmore')  <i
