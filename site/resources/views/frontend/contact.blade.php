                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tname" ​ placeholder="@lang('mega.namePlaceholder')" required name="tname">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="temail" value="" placeholder="@lang('mega.emailPlaceholder')" ​required name="temail">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="tphone" value="" ​ placeholder="@lang('mega.phonePlaceholder')" required name="tphone">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="tmessage" rows="3" placeholder="@lang('mega.messagePlaceholder')" required></textarea>
                                        <div class="invalid-feedback">
