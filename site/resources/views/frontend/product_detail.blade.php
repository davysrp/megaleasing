                                        ...
                                        <table class="ad-price-table-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($product->max_installment_period >=1)
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        @endif
                                                        @if($product->max_installment_period >=2)
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                        ...
                                                        @endif
                                                        @if($product->max_installment_period >=3)
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                        ...
                                                        @endif
                                                        @if($product->max_installment_period >=4)
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                        ...
                                                        @endif
                                                        @if($product->max_installment_period >=5)
                                                    ...
                                                    <div style="display: none;" id="interest_rate">{!! $product->interest_rate !!}</div>
                        ...
                        <script>
                            $('#checkfield').click(function (e) {
                                ...
                                if(name == '' || name == undefined){
                                    e.preventDefault();
                                    $("#tname").next().css('display', 'inherit');
                                }else {
                                    $("#tname").next().css('display', 'none');
                                }
