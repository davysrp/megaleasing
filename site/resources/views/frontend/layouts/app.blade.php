    ...
    <!-- Scripts -->
        ...
        @if($locale !='en')
            <style>
                ...
                /*@import url('https://fonts.googleapis.com/css2?family=Content&family=Source+Sans+Pro&display=swap');*/
                @import url('https://fonts.googleapis.com/css?family=Kantumruy:300,400,700|Lato:300,400,700');
                body {
                    font-family: 'Kantumruy', "Lato", sans-serif;
                    font-size: 15px;
                }
            </style>
        @endif
...
$faq = \App\Models\Explore\Explore::find(3);
                ...
                <div class="col-md-6">
                    <div class="ad-h-top-left">
                        <ul class="ad-h-top-nav">
                            ...
                            <li>
                                <a href="{!! route('frontend.explore',['id'=>$faq->id,'slug'=>\Illuminate\Support\Str::slug($faq->title_eng)]) !!}">
                                    @if($locale =='en')
                                        {!!  $faq->title_eng !!}
                                    @else
                                        {!!  $faq->title !!}
                        ...
                        <li>
                            <div class="ad-d-search">
                                ...
                                <input class="form-control me-2 t-search" type="search" name="t-search"
                                       placeholder="@lang('mega.Search')" aria-label="Search">
                        ...
                        @if($item->sub=='1')
                            ...
                            @if($item->id == 18)
                                <li class="has-submenu has-megamenu">
                                    <a id="branches-href" href="{!! route('frontend.branches') !!}">@if($locale =='en')
                                            {!! $item->title_eng !!}
                                        @else
                                            {!! $item->title !!}
                                        @endif </a>
...
<footer class="ad-main-footer">
    ...
    width: 70%;" class="form-control me-2 t-search" type="email" name="t-email"
    ...
    color: #fff;
    background: #003c7b;
    line-height: 1.5;" class="btn btn-outline-success" type="submit"><i class="far fa-paper-plane"></i>
                            </button>
                            {{ Form::close() }}
...
<script>
    jQuery(document).ready(function ($){
        if(sessionStorage && !sessionStorage.getItem('isshow')){
            bootbox.dialog({
                {{--message: '<img style="width: 100%; height: 100%" src="{!! asset("megaleasing/assets/images/news-3.jpg") !!}" alt="">',--}}
                message: '<?php echo $setting->popupImage != "" ? '<img style="width: 100%; height: 100%" src="'.$setting->popupImage.'" alt="">': '<iframe width="100%" height="380" src="https://www.youtube.com/embed/'.$setting->popupVideo.'??rel=0&modestbranding=1&autohide=1&mute=1&showinfo=0&controls=1&autoplay=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'; ?>',
                size: 'large',
                onEscape: false,
                backdrop: true,
                centerVertical: true,
