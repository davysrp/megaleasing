                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="tname" name="tname" value="" placeholder="@lang('mega.namePlaceholder')" required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="temail" name="temail" value="" placeholder="@lang('mega.emailPlaceholder')" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <div class="col-sm-12">
                                            <textarea class="form-control" name="tproblem" rows="5" placeholder="@lang('mega.factPlaceholder')" required></textarea>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <div class="col-sm-12">
                                            <textarea class="form-control" name="tmessage" rows="6" placeholder="@lang('mega.messagePlaceholder')" required></textarea>
                                            <div class="invalid-feedback">
