<!--Action Button-->
@if( Active::checkUriPattern( 'admin/branches' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.branches.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.branches.all' ) }}
            </a>
        </li>
        @permission( 'create-branch' )
            <li>
                <a href="{{ route( 'admin.branches.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.branches.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
