<!--Action Button-->
@if( Active::checkUriPattern( 'admin/managementteams' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.managementteams.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.managementteams.all' ) }}
            </a>
        </li>
        @permission( 'create-managementteam' )
            <li>
                <a href="{{ route( 'admin.managementteams.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.managementteams.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
