<div class="box-body">
    ...
    <div class="form-group">
        <!-- Create Your Field Label Here -->
        <!-- Look Below Example for reference -->
        {{ Form::label('description_kh', 'Description Kh', ['class' => 'col-lg-2 control-label required']) }}

        <div class="col-lg-10">
            <!-- Create Your Input Field Here -->
            <!-- Look Below Example for reference -->
            {{ Form::textarea('description_kh', null, ['class' => 'form-control box-size', 'placeholder' =>'Description Kh', 'required' => 'required']) }}
        </div><!--col-lg-10-->
    </div><!--form-group-->
...
@section("after-scripts")
    ...
    <script>
        ...
        $('textarea[name=description_kh]').ckeditor({
            filebrowserImageBrowseUrl: route_prefix + '?type=Images',
            filebrowserImageUploadUrl: route_prefix + '/upload?type=Images&_token={{csrf_token()}}',
            filebrowserBrowseUrl: route_prefix + '?type=Files',
            filebrowserUploadUrl: route_prefix + '/upload?type=Files&_token={{csrf_token()}}'
