<!--Action Button-->
@if( Active::checkUriPattern( 'admin/pagemenus' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.pagemenus.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.pagemenus.all' ) }}
            </a>
        </li>
        @permission( 'create-pagemenu' )
            <li>
                <a href="{{ route( 'admin.pagemenus.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.pagemenus.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
