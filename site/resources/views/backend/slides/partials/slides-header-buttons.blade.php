<!--Action Button-->
@if( Active::checkUriPattern( 'admin/slides' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.slides.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.slides.all' ) }}
            </a>
        </li>
        @permission( 'create-slide' )
            <li>
                <a href="{{ route( 'admin.slides.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.slides.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
