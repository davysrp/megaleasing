<!--Action Button-->
@if( Active::checkUriPattern( 'admin/newslists' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.newslists.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.newslists.all' ) }}
            </a>
        </li>
        @permission( 'create-newslist' )
            <li>
                <a href="{{ route( 'admin.newslists.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.newslists.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
