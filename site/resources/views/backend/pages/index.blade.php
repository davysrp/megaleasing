                ...
                <table id="pages-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.backend.pages.table.route') }}</th>
                            <th>{{ trans('labels.backend.pages.table.order_by') }}</th>
        ...
        $(function() {
            ...
            var dataTable = $('#pages-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'route', name: '{{config('module.pages.table')}}.route'},
                    {data: 'order_by', name: '{{config('module.pages.table')}}.order_by'},
