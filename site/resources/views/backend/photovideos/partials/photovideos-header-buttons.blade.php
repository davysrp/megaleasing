<!--Action Button-->
@if( Active::checkUriPattern( 'admin/photovideos' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.photovideos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.photovideos.all' ) }}
            </a>
        </li>
        @permission( 'create-photovideo' )
            <li>
                <a href="{{ route( 'admin.photovideos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.photovideos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
