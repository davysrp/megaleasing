<!--Action Button-->
@if( Active::checkUriPattern( 'admin/boarddirectors' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.boarddirectors.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.boarddirectors.all' ) }}
            </a>
        </li>
        @permission( 'create-boarddirector' )
            <li>
                <a href="{{ route( 'admin.boarddirectors.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.boarddirectors.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
