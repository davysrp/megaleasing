...
Route::post('send-partner/', 'FrontendController@partnerRequestMail')->name('sendPartnerMail');
...
//Route::get('about-company/board-of-directors/', 'FrontendController@board_of_director')->name('board_of_director');
